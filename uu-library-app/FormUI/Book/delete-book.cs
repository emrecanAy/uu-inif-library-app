...
namespace uu_library_app
{
    public partial class delete_book : Form
    {
        ...
        private void listDataToTable()
        {
            ...
            dataGridView1.Columns[6].HeaderText = "İsim";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtAd.Text = dataGridView1.Rows[e.RowIndex].Cells[6].Value.ToString();
            txtCevirmen.Text = dataGridView1.Rows[e.RowIndex].Cells[14].Value.ToString();
            txtCiltNo.Text = dataGridView1.Rows[e.RowIndex].Cells[10].Value.ToString();
            txtIsbn.Text = dataGridView1.Rows[e.RowIndex].Cells[8].Value.ToString();
            txtSayfaSayisi.Text = dataGridView1.Rows[e.RowIndex].Cells[7].Value.ToString();
            txtStokAdet.Text = dataGridView1.Rows[e.RowIndex].Cells[11].Value.ToString();
            cmbDil.Text = dataGridView1.Rows[e.RowIndex].Cells[1].Value.ToString();
            cmbKategori.Text = dataGridView1.Rows[e.RowIndex].Cells[3].Value.ToString();
            cmbKonum.Text = dataGridView1.Rows[e.RowIndex].Cells[5].Value.ToString();
