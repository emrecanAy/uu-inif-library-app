...
namespace uu_library_app.Core.Utils
{
    ...
    {
        public static void SendMailForExpired(Student student, Book book, DepositBook depositBook)
        {
        ...
        public static void SendMailReminding(Student student, Book book, DepositBook depositBook)
        {
